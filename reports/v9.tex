...
\jb{We'll remove these and focus on the Multi-BLiMP} Per-token perplexity --- linear  & 0.071 & 5.43 \\
Bits-per-byte --- linear         & 0.012 & 5.49 \\
\bottomrule
\jb{TODO: add p values / Spearman correlation}
\end{tabular}
...
\jb{This is a little slippery, since the interaction effects may be marginalized, and can still be used in the rank1 approximation. Move to appendix}}
\label{fig:rank1}
\end{figure}
...
\jb{I'm trying to think of how we could demonstrate From Claude:}
\jb{TODO: just put this in the appendix. Inline you can say something about having a 2-shot prompt, but not much more elaboration is needed}
